...
// por isso, nao vamos colocar o util constructor
const util = Util
...
class Tela {
    ...
    static altrerarConteudoHtml(codigoHtml) {
    ...
    static atualizarImagens(itens) {
        ...
        Tela.altrerarConteudoHtml(codigoHtml)
    }
    ...
    static iniciarContador() {
        ...
        // vamos substituir o texto começando $$contandor segundos
        ...
        // essa função vai substituir o $$contador pelço `contarAte` diminuindo o valor
        // retornamos o idNoIntervalo para parar ele mais tarde
